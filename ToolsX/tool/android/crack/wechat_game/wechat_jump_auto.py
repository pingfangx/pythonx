...
# 来自 https://github.com/wangshub/wechat_jump_game
...
press_coefficient = 1.472  # 长按的时间系数，请自己根据实际情况调节
...
def jump(distance):
    ...
    press_coefficient = 715 / len0
    press_time = distance * press_coefficient + 50
